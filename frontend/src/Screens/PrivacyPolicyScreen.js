  ...
  return (
    <div  className="text-entry">
      ...
      <p>
        ...
        earthshippackaging.myshopify.com (the “Site”).
        <br />
        <br />
        ...
        <br />
        We also Google Analytics to help us understand how our customers use the
        ...
        info@earthshippackaging.com or by mail using the details provided below:
        <br/><br/>
        Earthship Packaging<br/>
        [Re: Privacy Compliance Officer]<br/>
        1850 w.51st ave, Denver CO 80221, United States
