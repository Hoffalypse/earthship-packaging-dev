  ...
  return (
    <div style={{ textAlign: "center" }} className="text-entry">
      ...
      <p>
        ...
        packaging. Special order items are non refundable.
        <br />
        <br />
        ...
        contact us at info@earthshippackaging.com.
        <br />
        <br />
        ...
        info@earthshippackaging.com and send your item to: 1850 w.51st ave,
        Denver CO 80221, United States.
        <br />
        <br />
        Gifts
        <br />
        ...
        Shipping
        <br />
        To return your product, you should mail your product to: 1850 w.51st
        ave, Denver CO 80221, United States
        <br />
        <br />
