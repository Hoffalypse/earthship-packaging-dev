  ...
  return (
    <div  className="text-entry">
      ...
      <p>
        ...
        <br />
        <br />
        This website is operated by Earthship Packaging. Throughout the site,
        the terms “we”, “us” and “our” refer to Earthship Packaging. Earthship
        Packaging offers this website, including all information, tools and
        ...
        shall Earthship Packaging, our directors, officers, employees,
        ...
        <br />
        <br />
        You agree to indemnify, defend and hold harmless Earthship Packaging and
        ...
        <br />
        <br />
        Questions about the Terms of Service should be sent to us at info@earthshippackaging.com.
      </p>
    </div>
  );
};
